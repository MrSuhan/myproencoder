...
async def convert_video(video_file, output_directory, total_time, bot, message, chan_msg):
    ...
    preset.append("fast")
    audio_b.append("40k")
    watermark.append('-vf "drawtext=fontfile=font.ttf:fontsize=10:fontcolor=white:bordercolor=black@0.50:x=w-tw-10:y=10:box=1:boxcolor=black@0.5:boxborderw=6:text=Encoded"')
 ...
 #Done !!
    ...
    while process.returncode != 0:
      ...
      with open(DOWNLOAD_LOCATION + "/progress.txt", 'r+') as file:
        ...
        stats = f'🗜️ Encoding Please Wait...👀</b>\n\n' \
                f'🕰️ Eta :</b> {ETA}\n\n' \
                f'{progress_str}\n\n'
        try:
